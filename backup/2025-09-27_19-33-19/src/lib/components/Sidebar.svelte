<script lang="ts">
	...
	<aside class="top-24 fixed left-0 h-[calc(100vh-96px)] bg-surface-2 border-r border-border-subtle z-40 transition-all duration-500 ease-in-out {sidebarOpen ? 'translate-x-0' : '-translate-x-full'} md:translate-x-0 {sidebarCollapsed ? 'w-16' : 'w-[216px]'}" style="transition: width 500ms cubic-bezier(0.4, 0, 0.2, 1), transform 500ms cubic-bezier(0.4, 0, 0.2, 1);">
