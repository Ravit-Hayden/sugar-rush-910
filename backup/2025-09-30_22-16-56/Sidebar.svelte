...
<aside 
	...
	class:md:w-[72px]={sidebarCollapsed}
	class:md:w-[250px]={!sidebarCollapsed}
	...
	<div class="h-full w-full overflow-hidden">
		<nav class="h-full flex flex-col">
			...
			<div class="flex items-center h-20 border-b border-border-subtle flex-shrink-0 px-6">
				...
				<!-- 로고 - 메뉴 텍스트와 동일한 방식으로 처리 -->
				<div class="transition-opacity duration-200 ease-in-out ml-3 {sidebarCollapsed ? 'opacity-0 w-0 overflow-hidden' : 'opacity-100'}">
