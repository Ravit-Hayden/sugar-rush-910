		...
		<div class="h-full flex flex-col">
			...
			<div class="flex-1 bg-surface-1 rounded p-4 flex items-center justify-center min-h-0">
				<div class="w-full h-full flex flex-col items-center justify-center">
					<!-- 간단한 막대 차트 시뮬레이션 -->
					<div class="w-full flex items-end justify-center gap-1 mb-3" style="height: min(140px, 100%);">
						...
						<div class="bg-hover-cyan rounded-t" style="height: 70%; width: 16px;"></div>
						<div class="bg-brand-pink rounded-t" style="height: 90%; width: 16px;"></div>
						<div class="bg-hover-cyan rounded-t" style="height: 55%; width: 16px;"></div>
						<div class="bg-brand-pink rounded-t" style="height: 75%; width: 16px;"></div>
						<div class="bg-hover-cyan rounded-t" style="height: 65%; width: 16px;"></div>
						<div class="bg-brand-pink rounded-t" style="height: 85%; width: 16px;"></div>
						<div class="bg-hover-cyan rounded-t" style="height: 50%; width: 16px;"></div>
						<div class="bg-brand-pink rounded-t" style="height: 95%; width: 16px;"></div>
						<div class="bg-hover-cyan rounded-t" style="height: 40%; width: 16px;"></div>
					</div>
