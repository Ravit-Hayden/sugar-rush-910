...
<div class="card-base h-[396px] flex flex-col justify-between p-5 rounded-lg bg-surface-2 border border-border-subtle overflow-hidden pt-[24px]">
	<div class="flex-1 min-h-0">
		...
		<div class="flex items-center justify-between mb-4">
			...
			<button class="inline-flex items-center justify-center w-5 h-5 rounded-full hover:bg-surface-1 transition-colors ml-2" aria-label="정보" title="내가 해야 할 업무와 호출 멘션 요약" type="button">
	...
	<div class="flex items-center justify-between mt-3 flex-shrink-0">
		...
		<a href="/tasks" class="text-brand-pink text-sm font-semibold px-2 py-1 rounded hover:bg-hover-cyan transition-colors">더보기</a>
	</div>
</div>
