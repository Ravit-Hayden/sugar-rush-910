...
<header class="h-20 fixed top-0 left-0 right-0 z-[60] bg-bg transition-all duration-300" style="margin-left: {sidebarWidth}px;">
		...
		<div class="flex items-center gap-2 sm:gap-4 flex-1 justify-end">
			...
			<div class="flex items-center flex-shrink-0">
				...
				>
					...
					<!-- 새로운 알림 표시 점 -->
					<span 
						class="absolute top-0.5 right-0.5 w-1 h-1 rounded-full transition-colors" 
