	...
	try {
		...
		if (!db) {
			...
			const sampleArtists: Artist[] = [
				...
				{
					id: 'artist_sugar-rush-band_sample',
					name: 'Sugar Rush Band',
					description: 'Sugar Rush의 밴드 버전 프로젝트',
					photo_url: undefined,
					website: undefined,
					email: undefined,
					instagram: undefined,
				...
				{
					id: 'artist_sugar-rush-collective_sample',
				...
				{
					id: 'artist_sugar-rush-duo_sample',
					name: 'Sugar Rush Duo',
				...
				{
					id: 'artist_sugar-rush-ensemble_sample',
				...
				{
					id: 'artist_sugar-rush-group_sample',
				...
				{
					id: 'artist_sugar-rush-project_sample',
				...
				{
					id: 'artist_sugar-rush-studio_sample',
				...
				{
					id: 'artist_sugar-rush-team_sample',
				...
				{
					id: 'artist_sugar-rush-unit_sample',
