...
<header class="h-24 px-3 sm:px-4 md:px-6 sticky top-0 z-50 bg-bg">
		...
		<div class="flex items-center gap-4">
			...
			<div class="flex items-center flex-shrink-0">
				<button
					...
					class="inline-flex items-center justify-center w-6 h-6 rounded-md transition-colors focus:outline-none focus:ring-0"
			...
			<!-- 3. 페이지 제목 (메인 콘텐츠와 정렬) -->
			<div class="hidden sm:flex items-center flex-shrink-0 ml-6">
				{#if searchValue.trim()}
			...
			<div class="flex items-center">
				<div class="relative w-full max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg xl:max-w-xl">
					...
					<input
						...
						type="text"
						placeholder="검색..."
						class="pl-10 pr-10 py-1.5 w-full min-w-[80px] bg-surface-1 border border-border-subtle border-[1px] rounded-md text-text-base placeholder-text-muted hover:border-hover-cyan focus:outline-none focus:ring-0 focus:border-[1px] focus:border-brand-pink transition-colors duration-300"
