...
<div class="min-h-screen bg-bg">
	...
	<main class="pt-14 px-6 transition-all duration-500 ease-in-out {sidebarCollapsed ? 'md:ml-16' : 'md:ml-[216px]'} {sidebarOpen ? 'ml-16' : 'ml-0'}" style="background-color: var(--bg); min-height: calc(100vh - 96px);">
		{@render children?.()}
	</main>
</div>
