		...
		<div class="flex items-center gap-4">
			...
			<div class="relative">
				...
				<input
					...
					type="text"
					placeholder="검색..."
					class="pl-10 pr-4 py-1.5 w-64 bg-surface-1 border border-border-subtle rounded-md text-text-base placeholder-text-muted hover:border-hover-cyan focus:outline-none focus:ring-0 focus:border-brand-pink transition-colors"
